  ...
  return (
    <header class="bg-blue-900">
      <div class="container mx-auto">
        <div class="flex items-center py-2 mx-2 sm:mx-24">
          <div class="w-1/2">
            <div class="flex items-center ">
              ...
              <div class="w-full relative">
                <input
                  type="text"
                  class="appearance-none w-full h-6 py-1 px-2 rounded text-sm border"
                  placeholder="Search"
                />
          ...
          <div class="w-1/2 flex justify-end items-center text-xs font-bold">
            <a href="" class="flex mr-4 items-center no-underline">
              <img
                class="h-6 w-6 rounded-full"
                src="https://gravatar.com/avatar/b19536334f76e904381e09b5a8776646?s=512&d=https://static.codepen.io/assets/avatars/user-avatar-512x512-6e240cf350d2f1cc07c2bed234c3a3bb5f1b237023c204c782622e80d6b212ba.png"
              ></img>
              <span class="text-white ml-1"> Jafar</span>
            </a>
